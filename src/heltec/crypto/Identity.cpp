// Heltec fork of src/Identity.cpp — keep in sync when upstream Identity changes.
// Companion uses orlp ed25519_verify (see HELTEC_USE_ORLP_ED25519_VERIFY in platformio.ini).
